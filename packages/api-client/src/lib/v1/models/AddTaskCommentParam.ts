...
export type AddTaskCommentParam = {
  /**
   ...
   */
  body_type?: AddTaskCommentParam.body_type;
  /**
   ...
   */
  external_asset_type?: AddTaskCommentParam.external_asset_type;
  /**
...
export namespace AddTaskCommentParam {
